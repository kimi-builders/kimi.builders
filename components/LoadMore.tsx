    ...
    <>
      ...
      {cursor !== null && (
        <button
          ...
          onClick={more}
          disabled={busy}
          className="col-span-full border border-line px-5 py-1.5 font-mono text-xs text-grey transition-colors hover:border-blue hover:text-blue disabled:opacity-40"
        >
