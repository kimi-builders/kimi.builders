...
export const SEG_ITEM =
  "inline-flex h-full min-h-0 items-center rounded-md px-3 font-mono text-[11px] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue";
