  ...
  try {
    ...
    await connection.query(
      ...
      [
        ...
        ["cli", "local-dashboard"].includes(payload.client.surface) ? detectedTerminalName : null,
        ["cli", "local-dashboard"].includes(payload.client.surface) ? detectedTerminalVersion : null,
        ["cli", "local-dashboard"].includes(payload.client.surface) ? detectedTerminalName : null,
