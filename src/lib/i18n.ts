...
const DICT = {
  ...
  "kbd.sectionExplore": { zh: "探索", en: "EXPLORE" },
  "kbd.search": { zh: "打开搜索", en: "Open search" },
  "kbd.pick": { zh: "选择结果", en: "Select result" },
  "kbd.open": { zh: "打开所选", en: "Open selected" },
  "kbd.help": { zh: "快捷键帮助", en: "Shortcut help" },
  "kbd.esc": { zh: "关闭弹层", en: "Close overlay" },
  "kbd.theme": { zh: "切换深浅主题", en: "Toggle theme" },
  "kbd.lang": { zh: "切换中 / 英文", en: "Toggle language" },
  "kbd.vibe": { zh: "切换视觉气质", en: "Toggle visual style" },
  ...
  "set.emailTitle": { zh: "邮箱与验证", en: "Email & verification" },
  "set.emailVerified": { zh: "已验证", en: "Verified" },
  "set.emailUnverified": { zh: "未验证", en: "Not verified" },
  "set.emailUnverifiedHint": {
    zh: "未验证的邮箱不能用于找回密码；验证邮件 24 小时内有效。",
    en: "An unverified mailbox can't recover your password; verification links last 24 hours.",
  },
  "set.resend": { zh: "重发验证邮件", en: "Resend verification email" },
  "set.resendDone": { zh: "验证邮件已发送，请查收。", en: "Verification email sent — check your inbox." },
  "set.changeEmailHint": {
    zh: "更换需要在新邮箱中点击确认邮件后生效；确认时其他设备会退出登录。",
    en: "A change takes effect after you confirm it from the new mailbox; other devices get signed out then.",
  },
  "set.newEmailPh": { zh: "新邮箱", en: "New email" },
  "set.changeEmail": { zh: "更换邮箱", en: "Change email" },
  "set.emailChangeSent": { zh: "确认邮件已发送至新地址。", en: "Confirmation email sent to the new address." },
  "set.pendingChange": {
    zh: "换邮箱确认进行中：{e}（在新邮箱中点击确认后生效）",
    en: "Email change pending: {e} (confirm it from the new mailbox)",
  },
  "set.emailSame": { zh: "新邮箱与当前邮箱一致。", en: "Same as the current email." },
  "set.emailTaken": { zh: "该邮箱已被使用。", en: "That email is already in use." },
  "set.mailFailed": { zh: "邮件发送失败，请稍后再试。", en: "Couldn't send the mail — try again later." },
  "set.noEmail": { zh: "该账号没有绑定邮箱。", en: "No email on this account." },
  "set.sessionsTitle": { zh: "设备与会话", en: "Devices & sessions" },
  "set.sessionsHint": {
    zh: "当前登录中的设备；发现不认识的会话就注销它。",
    en: "Signed-in devices; revoke anything you don't recognize.",
  },
  "set.currentDevice": { zh: "当前设备", en: "This device" },
  "set.signedInAt": { zh: "登录于 {t}", en: "Signed in {t}" },
  "set.lastSeen": { zh: "活跃于 {t}", en: "Active {t}" },
  "set.revoke": { zh: "注销", en: "Revoke" },
  "set.logoutEverywhere": { zh: "登出所有设备", en: "Log out everywhere" },
  "set.logoutEverywhereDone": { zh: "已在所有设备登出。", en: "Signed out everywhere." },
  "set.verifyOkBanner": { zh: "邮箱验证完成。", en: "Email verified." },
  "set.verifyFailBanner": { zh: "链接无效或已过期，请重新发送验证邮件。", en: "Link invalid or expired — resend the verification email." },
  "set.emailChangedBanner": { zh: "登录邮箱已更换。", en: "Login email changed." },
  "set.unlinkConfirm": {
  ...
  "works.backToAwesome": { zh: "返回 Awesome", en: "Back to Awesome" },
  "gate.login": { zh: "登录 / 注册", en: "Sign in / Register" },
  "gate.hint": { zh: "支持邮箱与 GitHub / Google", en: "Email, GitHub & Google supported" },
  "gate.usage": { zh: "登录后连接设备并同步用量", en: "Sign in to connect a device and sync usage" },
  "gate.post": { zh: "登录后发布帖子", en: "Sign in to post" },
