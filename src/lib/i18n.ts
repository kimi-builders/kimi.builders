...
const DICT = {
  ...
  "works.coverToneAwesomeHint": {
    zh: "不选则按类型定色(应用绿/工具蓝/智能体红/内容与其他黑);选定后固定,不随主题切换。",
    en: "Unset = color by kind family (apps green, tools blue, agents red, content & others black). A picked color is fixed and won't follow the theme.",
  },
