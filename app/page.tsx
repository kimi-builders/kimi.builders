        ...
        <nav className="mt-6 flex flex-wrap items-stretch justify-center gap-2.5 font-mono text-xs">
          {(
            ...
            <Link
              key={href}
              href={href}
              className="kb-navlink flex w-[9.75rem] flex-col items-center gap-1 rounded-lg border border-line px-2 py-2.5 text-grey transition-colors hover:border-ui-blue hover:text-ui-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue"
            >
