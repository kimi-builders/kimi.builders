...
export default async function UsageDeviceContent({
  ...
  return (
    <div className="mx-auto max-w-xl">
      <a href="/usage" className="inline-flex min-h-11 items-center font-mono text-xs text-grey hover:text-ui-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue">
        ← {zh ? "用量看板" : "Usage"}
      </a>
      {showTitle && (
        <h1 className="mt-5 flex items-center gap-2 text-2xl font-semibold text-paper">
        ...
        <>
          ...
          <section className="mt-7 rounded-xl border border-line bg-card p-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              <span className="w-10 shrink-0 font-mono text-xs text-grey">
                {zh ? "看板" : "UI"}
              </span>
            ...
            <details className="mt-3 border-t border-line pt-3">
              <summary className="cursor-pointer font-mono text-xs text-grey hover:text-paper">
                {zh ? "终端备用方式" : "CLI fallback"}
              </summary>
              <div className="mt-2 flex items-center gap-2">
                <span className="w-10 shrink-0 font-mono text-xs text-grey">CLI</span>
                <div className="flex min-w-0 flex-1 items-stretch overflow-hidden rounded-lg border border-line bg-bg">
                  <code className="min-w-0 flex-1 overflow-x-auto whitespace-nowrap px-3 py-2 font-mono text-xs text-paper">
                    {USAGE_INIT_COMMAND}
                  </code>
        ...
        <>
          ...
          <section className="mt-7 rounded-xl border border-line bg-card p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <div className="font-mono text-xs tracking-[0.08em] text-grey">
                  {zh ? "连接请求" : "CONNECTION REQUEST"}
                </div>
                <div className="mt-2 font-mono text-xl font-semibold tracking-[0.08em] text-paper">
                  {code}
                </div>
              </div>
              <span className="border border-line px-2 py-1 font-mono text-xs text-grey">
          ...
          <section className="mt-4 grid gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-line p-4">
              <Database size={16} className="text-ui-blue" />
              <h2 className="mt-3 text-sm font-medium text-paper">
            ...
            <div className="mt-6 rounded-xl border-l-2 border-blue bg-blue/5 p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2 font-mono text-xs">
                <a
                  ...
                  className="inline-flex min-h-11 items-center px-2 text-ui-blue hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue"
                >
                  GitHub →
                </a>
                <a
