      ...
      >
        ...
        <div className="max-h-[calc(86vh-76px)] space-y-3 overflow-y-auto px-5 py-4">
          <a
            href={csvHref}
            onClick={() => dialogRef.current?.close()}
            className="flex min-h-20 items-start gap-3 border border-line bg-card p-4 hover:border-ui-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue"
          >
          ...
          <a
            ...
            className="flex min-h-20 items-start gap-3 border border-line bg-card p-4 hover:border-ui-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue"
          >
            <FileJson2 size={19} className="mt-0.5 shrink-0 text-ui-blue" aria-hidden="true" />
            <span>
          ...
          <p className="flex items-start gap-2 border-t border-line pt-4 text-xs leading-relaxed text-grey">
