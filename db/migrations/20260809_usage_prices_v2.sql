...
--   gpt-5.5 $5/$30 缓存 $0.50;gpt-5.5-pro $30/$180(OpenAI 官方价格表 2026-08)
--   gpt-5.4 $2.50/$15 缓存 $0.25(OpenAI 官方价格表 2026-08);gpt-5.3-codex $1.75/$14
...
SELECT * FROM (
  ...
  SELECT 'gpt-5.5-pro', 'prefix', NULL, '2026-06-01 00:00:00', NULL, 'USD', 30.00, NULL, NULL, 180.00, NULL,
         '2026-08-09', 'OpenAI 官方价格表 2026-08;缓存价未公布' UNION ALL
  ...
  SELECT 'gpt-5.4', 'prefix', NULL, '2026-04-01 00:00:00', NULL, 'USD', 2.50, NULL, 0.25, 15.00, NULL,
         '2026-08-09', 'OpenAI 官方价格表 2026-08' UNION ALL
  ...
  SELECT 'gemini-3-flash-preview', 'prefix', NULL, '2026-05-01 00:00:00', NULL, 'USD', 0.50, NULL, 0.05, 3.00, NULL,
         '2026-08-09', 'Google 官方 Standard 价格表 2026-08' UNION ALL
